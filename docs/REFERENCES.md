...
Total entries: 1,000 (100 curated annotated entries + 900 extended Crossref entries)
...
This unannotated discovery index adds 900 Crossref-derived references to the 100 hand-curated entries above, bringing the guide bibliography to 1,000 total entries.
