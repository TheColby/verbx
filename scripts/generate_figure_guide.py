...
CORE = {
    ...
    3: ("RT60 decay families", "Idealized decay slopes for several nominal reverberation times, each reaching a 60 dB loss at its labeled RT60.", "multi", "Time after excitation (s)", "Relative decay level (dB)", ""),
    4: ("Energy decay curve fitting windows", "The EDT, T20, and T30 regression regions used to estimate decay from different portions of an energy decay curve.", "multi", "Normalized decay time (0-1)", "Energy decay level (dB)", ""),
