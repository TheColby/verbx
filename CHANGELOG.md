...
- Stable Python API surface at `verbx.api` with `render_file`, `generate_ir`,
  and `analyze_file` for programmatic workflows.
- Structured schema documentation for batch manifests and automation files
  (`docs/SCHEMAS.md`).
